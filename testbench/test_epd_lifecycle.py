...
class TestEPD7Lifecycle:
    ...
    def test_00_factory_reset_via_power_cycles(self, device):
    ...
    def test_02_production_firmware_ota(self, device, aws_verifier):
    ...
    def test_03_candidate_firmware_ota(self, device, aws_verifier):
    ...
    def test_04_device_activation(self, device, aws_verifier):
    ...
    def test_05_picture_render_and_payload(self, device, aws_verifier):
    ...
    def test_06_deactivate_and_deep_sleep(self, device, aws_verifier):
